...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUserId, queryParams, filters, validation, projectRepository, result, response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                validation = validation_1.ValidationService.validateProjectFilters(filters);
                ...
                return [4 /*yield*/, projectRepository.listProjects(filters)];
            case 2:
                result = _a.sent();
                response = {
                    success: true,
