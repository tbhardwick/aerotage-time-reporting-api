...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUserId, projectId, requestBody, validation, projectRepository, clientRepository, existingProject, client, updatedProject, response, error_1;
    var _a;
        ...
        switch (_b.label) {
            ...
            case 1:
                ...
                try {
                    ...
                    return [2 /*return*/, createErrorResponse(400, 'INVALID_JSON', 'Invalid JSON in request body')];
                }
                validation = validation_1.ValidationService.validateUpdateProjectRequest(requestBody);
            ...
            case 2:
                ...
                if (!(requestBody.clientId && requestBody.clientId !== existingProject.clientId)) return [3 /*break*/, 4];
                return [4 /*yield*/, clientRepository.getClientById(requestBody.clientId)];
            case 3:
                client = _b.sent();
                if (!client) {
                    return [2 /*return*/, createErrorResponse(404, 'CLIENT_NOT_FOUND', 'The specified client does not exist')];
                }
                if (!client.isActive) {
                    return [2 /*return*/, createErrorResponse(400, 'CLIENT_INACTIVE', 'Cannot assign project to inactive client')];
                }
                // Update client name to match
                requestBody.clientName = client.name;
                _b.label = 4;
            case 4: return [4 /*yield*/, projectRepository.updateProject(projectId, requestBody)];
            case 5:
            ...
            case 6:
                error_1 = _b.sent();
                console.error('Error updating project:', error_1);
                // Handle specific DynamoDB errors
                if (error_1 instanceof Error) {
                    if (error_1.message.includes('ConditionalCheckFailedException')) {
                        return [2 /*return*/, createErrorResponse(404, 'PROJECT_NOT_FOUND', 'Project not found')];
                    }
                    if (error_1.message.includes('No valid updates provided')) {
                        return [2 /*return*/, createErrorResponse(400, 'NO_UPDATES', 'No valid updates provided')];
                    }
                }
                return [2 /*return*/, {
                        statusCode: 500,
