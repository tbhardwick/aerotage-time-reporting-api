...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUserId, clientId, requestBody, validation, clientRepository, existingClient, nameExists, updatedClient, response, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                validation = validation_1.ValidationService.validateUpdateClientRequest(requestBody);
            ...
            case 2:
                ...
                if (!(requestBody.name && requestBody.name !== existingClient.name)) return [3 /*break*/, 4];
                return [4 /*yield*/, clientRepository.checkClientNameExists(requestBody.name, clientId)];
            case 3:
                nameExists = _b.sent();
                if (nameExists) {
                    return [2 /*return*/, createErrorResponse(409, 'CLIENT_NAME_EXISTS', 'A client with this name already exists')];
                }
                _b.label = 4;
            case 4: return [4 /*yield*/, clientRepository.updateClient(clientId, requestBody)];
            case 5:
