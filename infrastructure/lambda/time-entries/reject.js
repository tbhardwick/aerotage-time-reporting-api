...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var authContext, userId, userRole, requestData, validationErrors, rejectionErrors, _i, _a, timeEntryId, timeEntry, error_1, result, statusCode, message, response, error_2;
    var _b, _c;
    return __generator(this, function (_d) {
        switch (_d.label) {
            ...
            case 3:
                timeEntry = _d.sent();
                if (!timeEntry) {
                    rejectionErrors.push("Time entry ".concat(timeEntryId, " not found"));
                    return [3 /*break*/, 5];
                }
                // Check if time entry is in a rejectable state
                if (timeEntry.status !== 'submitted') {
                    rejectionErrors.push("Time entry ".concat(timeEntryId, " is not submitted for approval (status: ").concat(timeEntry.status, ")"));
                    return [3 /*break*/, 5];
                }
                return [3 /*break*/, 5];
            case 4:
                error_1 = _d.sent();
                rejectionErrors.push("Error checking time entry ".concat(timeEntryId, ": ").concat(error_1.message));
                return [3 /*break*/, 5];
            case 5:
                _i++;
                return [3 /*break*/, 1];
            case 6:
                ...
                return [4 /*yield*/, timeEntryRepo.rejectTimeEntries(requestData.timeEntryIds, userId, requestData.rejectionReason)];
            case 7:
                result = _d.sent();
                console.log("Rejected ".concat(result.successful.length, " time entries, ").concat(result.failed.length, " failed"));
                statusCode = 200;
                message = 'All time entries rejected successfully';
            ...
            case 8:
                error_2 = _d.sent();
                console.error('Error rejecting time entries:', error_2);
                return [2 /*return*/, {
                        statusCode: 500,
                        headers: {
                            'Content-Type': 'application/json',
