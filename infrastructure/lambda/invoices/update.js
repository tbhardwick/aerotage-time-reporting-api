...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var currentUserId, invoiceId, requestBody, validation, invoiceRepository, existingInvoice, updatedInvoice, response, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                validation = validation_1.ValidationService.validateUpdateInvoiceRequest(requestBody);
            ...
            case 2:
                ...
                if (existingInvoice.status === 'paid' || existingInvoice.status === 'cancelled') {
                    return [2 /*return*/, createErrorResponse(400, types_1.InvoiceErrorCodes.INVOICE_CANNOT_BE_MODIFIED, 'Paid or cancelled invoices cannot be modified')];
                }
                return [4 /*yield*/, invoiceRepository.updateInvoice(invoiceId, requestBody)];
            case 3:
            ...
            case 4:
                error_1 = _b.sent();
                console.error('Error updating invoice:', error_1);
                // Handle specific business logic errors
                if (error_1 instanceof Error) {
                    if (error_1.message.includes('Invoice not found') || error_1.message.includes('attribute_exists')) {
                        return [2 /*return*/, createErrorResponse(404, types_1.InvoiceErrorCodes.INVOICE_NOT_FOUND, 'Invoice not found')];
                    }
                    if (error_1.message.includes('No valid updates provided')) {
                        return [2 /*return*/, createErrorResponse(400, 'VALIDATION_ERROR', 'No valid updates provided')];
                    }
                }
                return [2 /*return*/, {
                        statusCode: 500,
