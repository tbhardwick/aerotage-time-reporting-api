...
var handler = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var invitationId, currentUserId, repository, invitation, response, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                return [4 /*yield*/, repository.updateInvitation(invitationId, {
                        status: 'cancelled',
                    })];
            case 3:
                // Update invitation status to cancelled
            ...
            case 4:
                error_1 = _b.sent();
                console.error('Error cancelling user invitation:', error_1);
                return [2 /*return*/, {
                        statusCode: 500,
                        headers: {
                            'Content-Type': 'application/json',
